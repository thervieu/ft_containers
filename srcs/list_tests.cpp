...
{
	std::cout << "LIST\n\n";
	std::cout << "CONSTRUCTORS : l1 = std ; l2 = ft\n\n";
...
{
	std::cout << "MAX_SIZE : l1 = std ; l2 = ft\n\n";
...
{
	std::cout << "FRONT AND BACK : l1 = std ; l2 = std ; l3 = ft\n\n";
...
{
	std::cout << "PUSH POP FRONT AND BACK : l1 = std ; l2 = ft\n\n";
...
{
	std::cout << "ERASE : std1 = std ; ft1 = ft\n\n";
...
static void	operators()
{
	...
	std::cout << "std1 <  std2 = " << (std1 < std2) << std::endl;
	std::cout << "ft1  <  ft2  = " << (ft1 < ft2) << std::endl << std::endl;
